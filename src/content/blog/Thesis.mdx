---
title: "Damned Veil: How I Automated Enemy Spawning Using PCG and Math"
date: 2025-05-20
description: "Designing levels for a bounce-mechanic shooter was driving me crazy, so I built a Procedural Content Generation (PCG) system to do it for me."
readTime: "6 min read"
...
> - **why CSP?** Because pure randomness is chaotic. CSP ensures the game remains balanced, fair, and mathematically solvable.

### The Results & Performance

I wasn't just going to guess if this system was good—I rigorously tested it across 15 different maps (5 small, 5 medium, and 5 large arenas) with a total of 149 trials. 

Here are the numbers:
- **Speed**: The algorithm took an average of **7.616 ms** to execute. That is blazing fast. It generates the entire enemy layout in the blink of an eye.
...
In the future, I want to evolve this system by adding:
- **Dynamic / Moving Enemies**
- **Adaptive Difficulty** (scaling the complexity based on how well the player is doing)
- **Complex Arena Structures** (like puzzles and boss mechanics)

<br />

> Combining Specular Path and CSP saved my sanity and made Damned Veil infinitely more replayable. Sometimes, the best way to design a game is to teach the game how to design itself!
