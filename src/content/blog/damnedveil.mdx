...
date: 2024-04-22
description: "A technical dive into building a dark pixel art game featuring strategic carrom-style mechanics, unity events, and experimental 2D normal maps."
readTime: "5 min read"
tags: ["Unity", "Game Dev", "C#", "Pixel Art"]
---
...
**Damned Veil** is a dark, horror-themed pixel game set in a mysterious magical world. refer to [Damned Veil](/projects/damnedveil) project page for more information.

As i mentioned before, I was responsible for creating the **art and environment** of the game. What makes this project special for me is my experiment with **normal mapping** in pixel art.
