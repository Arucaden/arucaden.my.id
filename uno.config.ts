...
export default defineConfig({
  ...
  shortcuts: [
    ...
    [
      'purosu',
      'prose prose-invert max-w-none w-full prose-p:max-w-none prose-p:w-full prose-headings:max-w-none prose-headings:w-full prose-p:text-gray-text prose-p:leading-relaxed prose-headings:text-white prose-headings:font-bold prose-h1:text-2xl prose-h2:text-xl prose-h2:border-b prose-h2:border-main/30 prose-h2:pb-2 prose-h3:text-lg prose-strong:text-white prose-a:text-main prose-a:no-underline hover:prose-a:underline prose-li:marker:text-main prose-li:text-gray-text prose-ul:list-disc prose-pre:bg-black/60 prose-pre:border prose-pre:border-white/10 prose-pre:rounded-xl prose-code:text-main prose-code:font-mono prose-table:border-collapse prose-table:text-white/90 prose-th:bg-main/15 prose-th:text-left prose-th:px-3 prose-th:py-2 prose-td:px-3 prose-td:py-2 prose-tr:border-b prose-tr:border-main/20',
    ],
  ],
  theme: {
    colors: {
